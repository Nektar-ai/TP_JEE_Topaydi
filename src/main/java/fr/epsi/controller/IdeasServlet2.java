...
@WebServlet("/ideas2")
public class IdeasServlet2 extends HttpServlet {
    ...
    {
	    	List<Idea> ideaz = service.getBuzzIdeas();
	    	req.setAttribute("listeIdeas", ideaz);
			this.getServletContext().getRequestDispatcher("/WEB-INF/pages/Ideas2.jsp").forward(req, resp);	
    }
